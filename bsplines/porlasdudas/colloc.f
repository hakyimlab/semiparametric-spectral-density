...
C     integer iorder,lbegin,ntimes,   i,iflag,ii,integs(3,100),iside
C    *            ,iter,itermx,k,kpm,l,lnew,m,n,nbloks,ncoef,nncoef,nt
C     data ncoef,lenblk / 2000,2000 /     
...
C     real addbrk,aleft,aright,relerr,   a(200),amax,asave(200)
C    *     ,b(200),bloks(2000),break,coef,dx,err,rho,t(200)
C    *     ,templ(2000),temps(200),xside
